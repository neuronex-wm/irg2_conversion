...
if ~isempty(CS.CompDataIdx)
   nwb.general_subject = types.core.Subject( ...
    'subject_id', T.SubjectID(CS.CompDataIdx), 'age', num2str(T.SubjectAge_years(CS.CompDataIdx)), ...
    'sex', T.SubjectSex(CS.CompDataIdx), 'species', T.SubjectBreed(CS.CompDataIdx), ...
    'weight', num2str(T.SubjectWeight_Kg(CS.CompDataIdx))     ... 
     );      
