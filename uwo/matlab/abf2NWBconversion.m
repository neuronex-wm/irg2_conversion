...
for n = 1:length(cellList)
    ...
    SweepAmp = [];stimOff = []; stimOnset = []; surplusAquiCount = 0;
...
%% Sweep table
     ...
     surplusAquiCount = length(sweep_series_objects_ch2)-...
                             length(sweep_series_objects_ch1);
     
     sweep_inds_vec = [[surplusAquiCount: ...
                        length(sweep_series_objects_ch1)+surplusAquiCount-1],...
                            [0:length(sweep_series_objects_ch2)-1]];
    ...
    nwb.general_intracellular_ephys_sweep_table = sweepTable;
        ...
        'SweepAmp') = ...
          types.hdmf_common.VectorData(...
           ...
           'data',[[SweepAmp(surplusAquiCount+1:end)]', [SweepAmp]']...
              ); 
    ...
    nwb.general_intracellular_ephys_sweep_table.vectordata.map(...
        'StimOn') = ...
          types.hdmf_common.VectorData(...
           ...
           'data', [[stimOnset(surplusAquiCount+1:end)]', [stimOnset]']...
              );   
    ...
    nwb.general_intracellular_ephys_sweep_table.vectordata.map(...
        'StimOff') = ...
          types.hdmf_common.VectorData(...
           ...
           'data', [[stimOff(surplusAquiCount+1:end)]', [stimOff]']...
              );   
%%    
    sessionTag = cell2mat(T.SubjectID(idx));
